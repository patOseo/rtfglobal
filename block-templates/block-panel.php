...
<div class="panel-block-container">
	<div class="text-center panel-block <?php if($panel_link): ?>hover<?php endif; ?>" style="background: linear-gradient(rgb(255 255 255 / 80%),rgb(255 255 255 / 80%)), url('<?php the_field('background_image'); ?>') no-repeat center center; background-size:cover;">
